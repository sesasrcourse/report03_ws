...
A timeout mechanism resets the goal if no landmark is detected, preventing the robot from pursuing outdated targets.
...
An additional penalty term is introduced to slow down the robot when approaching the goal:
\begin{equation}
...
For dynamic target following, a distance maintenance term is added:
\begin{equation}
