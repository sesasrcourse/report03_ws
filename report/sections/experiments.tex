...
\label{ssec:metrics}
To quantitatively assess the navigation system performance, the following metrics are considered: %during experimental trials:
...
\begin{itemize}
    ...
    \item \textbf{Average and Minimum distance to obstacles} using the \texttt{/scan} LiDAR data. 
\end{itemize}
