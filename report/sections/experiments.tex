...
\label{ssec:metrics}
% TODO pensare se vogliamo specificare il modo con cui calcoliamo queste metriche
...
The DWA controller is configured with the parameters shown in Table~\ref{tab:dwa_params}, tuned through iterative testing in simulation and adapted for the real robot platform.
...
Slowdown weight (Task 2a) & 0.1 & 0.1 & - \\
Target distance (Task 2b) & 0.3 & 0.3 & m \\
$\delta$ (target distance weight, Task 2b) & 0.1 & 0.1 & - \\
\hline
\end{tabular}
\end{table}

\input{sections/metrics_table.tex}
